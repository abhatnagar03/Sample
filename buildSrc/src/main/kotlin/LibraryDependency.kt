...
object LibraryDependency {
    ...
    const val PAGING = "android.arch.paging:runtime:${LibraryVersion.PAGING}"
    const val PAGING_KTX = "androidx.paging:paging-runtime-ktx:${LibraryVersion.PAGING}"
    const val LIVEDATA_KTX= "androidx.lifecycle:lifecycle-livedata-ktx:${LibraryVersion.LIFECYCLE_KTX}"
    const val MULTI_DEX = "com.android.support:multidex:${LibraryVersion.MULTI_DEX}"
    const val VIEW_PAGER_2 = "androidx.viewpager2:viewpager2:${LibraryVersion.VIEW_PAGER_2}"
}
